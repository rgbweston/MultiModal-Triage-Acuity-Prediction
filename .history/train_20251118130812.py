...
class MultiInputNet(nn.Module):
    # Structure: CNN for text + FC for structured data
    # Embedding dimensions: 768 for text, variable for structured data
...
# Utilise GPU from HPC cluster if available
...
# Save model and scaler for future use and inference (streamlit)
